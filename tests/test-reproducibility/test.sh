...
se_a=$(tail -n+2 result0/02_methyldackel/se/se_CpG.bedGraph | md5sum | cut -d' ' -f1)
se_b=$(tail -n+2 result1/02_methyldackel/se/se_CpG.bedGraph | md5sum | cut -d' ' -f1)
pe_a=$(tail -n+2 result0/02_methyldackel/pe/pe_CpG.bedGraph | md5sum | cut -d' ' -f1)
pe_b=$(tail -n+2 result1/02_methyldackel/pe/pe_CpG.bedGraph | md5sum | cut -d' ' -f1)
